                        ...
                        @foreach ($sections as $section)                        
                            <tr>
                              <th
                                  ...
                                  <img src="/images/{{ $section->filename }}"
                              ...
                              <td
                                  ...
                                  @if ($section->category == 1)
                                    Who we are
                                  @elseif ($section->category == 2)
                                    Our Service
                                  @elseif ($section->category == 3)
                                    Why Garuda Aquatic?
                                  @elseif ($section->category == 4)
                                    How to Order
                                  @endif
                              </td>
                              <td
                                  ...
                                  <div class="flex">
                                      ...
                                      <button class="text-red-600 block py-1 px-3" type="button" onclick="toggleModal('delete','{{ route('delete-section', $section->id) }}')">
                                          <i class="fas fa-trash"></i>
                                      </button>
                                      @if ($section->status == 1)
                                          <button class="text-blue-600 block py-1 px-3" type="button" onclick="toggleModal('deactive','{{ route('toggle-section', ['id' => $section->id, 'status' => 0]) }}')">
                                              <i class="fas fa-eye"></i>
                                          </button>
                                      @else
                                          <button class="text-blue-600 block py-1 px-3" type="button" onclick="toggleModal('active','{{ route('toggle-section', ['id' => $section->id, 'status' => 1]) }}')">
  ...
  <script type="text/javascript">
    ...
    function toggleModal(type, url){
        ...
        if(type === 'delete'){
            ...
            $('#modal-body').html("Are u sure want to delete this section?");
            $('#modal-url').html("Delete");
        }
        else if(type === 'active'){
            $('#modal-title').html("Active Section");
            $('#modal-body').html("Are u sure want to active this section?");
            $('#modal-url').html("Active");
        } 
        else if(type === 'deactive'){
            $('#modal-title').html("Deactive Section");
            $('#modal-body').html("Are u sure want to deactive this section?");
