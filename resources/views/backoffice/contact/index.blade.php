                        ...
                        @foreach ($contacts as $contact)                        
                            <tr>
                              ...
                              <td
                                  ...
                                  <div class="flex">                                                                                                                      
                                      @if ($contact->status == 1)
                                          <a href="#" class="text-blue-200 block py-1 px-3" type="button" title="Replied">
                                              <i class="fas fa-reply"></i>
                                          </a>
                                      @else
                                          <a href="{{ route('reply-message', $contact->id) }}" class="text-blue-600 block py-1 px-3" type="button" title="Reply Messages">
                                            <i class="fas fa-reply"></i>
                                          </a>
                                      @endif
                                      <button class="text-red-600 block py-1 px-3" type="button" title="Delete Messages">
