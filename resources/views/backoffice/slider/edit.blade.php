...
@section('content')
    <div class="flex flex-wrap">
        <div class="w-full px-4">
            ...
            @endif
            <div
                class="relative flex flex-col min-w-0 break-words w-full mb-6 shadow-lg rounded-lg bg-blueGray-100 border-0 bg-white">
                    ...
                    <form action="{{ route('update-slider', $slider->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="w-full px-4">
                                <div class="relative w-full mb-3">
                                    ...
                                    <input type="text"
                                        ...
                                        placeholder="Image Title" name="title" value="{{ $slider->title }}"/>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="w-full lg:w-12/12 px-4">
                                <div class="relative w-full mb-3">
                                    ...
                                    <textarea type="text" class="border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150"
                                        rows="4" placeholder="Text Here" name="description">{{ $slider->description }}</textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="flex justify-center">
                          <div class="w-full lg:w-12/12 px-4">
                            ...
                            <img class="w-full" src="/images/sliders/{{ $slider->filename }}" alt="">
                          </div>
                        </div>
