                      ...
                      @method('PUT')
                            ...
                            <div class="w-full px-4">
                                <div class="relative w-full mb-3">
                                    ...
                                    <input type="text"
                                        ...
                                        placeholder="Image Title" name="title" value="{{ $gallery->title }}"/>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="w-full lg:w-12/12 px-4">
                                <div class="relative w-full mb-3">
                                    ...
                                    <textarea type="text" class="border-0 px-3 py-3 placeholder-gray-300 text-gray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150"
                                        rows="4" placeholder="Text Here" name="description">{{ $gallery->description }}</textarea>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="relative w-full mb-3">
                              ...
                              <select name="category" class="form-select appearance-none
                                ...
                                focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none" aria-label="Default select example">
                                  ...
                                  <option value="0" @if ($gallery->category == 0) selected @endif>Our Farm</option>
                                  <option value="1" @if ($gallery->category == 1) selected @endif>Product</option>                                                                  
                              </select>
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="flex justify-center">
                          <div class="w-full lg:w-12/12 px-4">
                            ...
                            <img class="w-full" src="/images/gallery/{{ $gallery->filename }}" alt="">
                          </div>
                        </div>
                        <div class="flex justify-end">
                          ...
                          <div class="px-4 mt-10">
                            <a href="{{ url('/admin/home') }}" class="block bg-gray-300 px-6 py-2 rounded text-gray-50 uppercase font-bold">Cancel</a>
                          </div>
                        </div>
                    </form>
                </div>
