                        ...
                        @foreach ($news as $news)                        
                            <tr>
                              <th
                                  ...
                                  <img src="/images/news/{{ $news->filename }}"
                              ...
                              <td
                                  ...
                                  <div class="flex">
                                      ...
                                      <button class="text-red-600 block py-1 px-3" type="button" onclick="toggleModal('delete','{{ route('delete-news', $news->id) }}')">
                                          <i class="fas fa-trash"></i>
                                      </button>
                                      @if ($news->status == 1)
                                          <button class="text-blue-600 block py-1 px-3" type="button" onclick="toggleModal('deactive','{{ route('toggle-news', ['id' => $news->id, 'status' => 0]) }}')">
                                              <i class="fas fa-eye"></i>
                                          </button>
                                      @else
                                          <button class="text-blue-600 block py-1 px-3" type="button" onclick="toggleModal('active','{{ route('toggle-news', ['id' => $news->id, 'status' => 1]) }}')">
  ...
  <script type="text/javascript">
    ...
    function toggleModal(type, url){
        ...
        if(type === 'delete'){
            ...
            $('#modal-body').html("Are u sure want to delete this news?");
            $('#modal-url').html("Delete");
        }
        else if(type === 'active'){
            $('#modal-title').html("Active News");
            $('#modal-body').html("Are u sure want to active this news?");
            $('#modal-url').html("Active");
        } 
        else if(type === 'deactive'){
            $('#modal-title').html("Deactive News");
            $('#modal-body').html("Are u sure want to deactive this news?");
