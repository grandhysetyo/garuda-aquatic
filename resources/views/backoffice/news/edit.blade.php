                      ...
                      @method('PUT')
                            ...
                            <div class="w-full px-4">
                                <div class="relative w-full mb-3">
                                    ...
                                    <input type="text"
                                        ...
                                        placeholder="Image Title" name="title" value="{{ $news->title }}"/>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="w-full lg:w-12/12 px-4">
                                <div class="relative w-full mb-3">
                                    ...
                                    <textarea type="text" class="border-0 px-3 py-3 placeholder-gray-300 text-gray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150"
                                        rows="4" placeholder="Text Here" name="description">{{ $news->description }}</textarea>
                                </div>
                            </div>
                        </div>                                                                              
                        ...
                        <div class="flex justify-center">
                          <div class="w-full lg:w-12/12 px-4">
                            ...
                            <img class="w-full" src="/images/news/{{ $news->filename }}" alt="">
                          </div>
                        </div>
