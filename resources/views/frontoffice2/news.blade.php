    ...
    <div class="relative bg-second">
        <div class="container mx-auto px-3 py-16">
            <div class="flex flex-col">
                <h1 class="font-bold text-third text-xl mb-6">News</h1>
    ...
    <section>
        <div class="container px-5 py-2 mx-auto my-10">
            <div class="flex justify-center flex-wrap">
              @foreach ($news as $new)
              <div class="relative w-11/12 md:w-2/5 lg:w-1/4 m-4 bg-white rounded-lg border border-gray-200 shadow-md">
                  <a href="#">
                  ...
                  <div class="p-5">
                      <a href="#">
                          <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 max-h-16">
                              {{ \Illuminate\Support\Str::limit($new->title ?? '', 40, ' ...') }}</h5>
                      </a>
                      <p class="mb-3 font-normal text-gray-700 h-28">
                          {{ \Illuminate\Support\Str::limit($new->description ?? '', 140, ' ...') }}</p>
